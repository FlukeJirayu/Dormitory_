<div
    class="navbar-component relative"
    x-data="{ 
        modalOpen: @entangle('showModal'),
        editModalOpen: @entangle('showModalEdit'),
        init() {
            ...
            this.$watch('editModalOpen', (value) => {
                if (value) {
                    document.body.style.overflow = 'hidden';
                } else {
                    document.body.style.overflow = '';
    ...
    <!-- Main Navbar Content -->
    <div class="navbar p-6 bg-gradient-to-r from-white via-purple-50 to-blue-50 shadow-xl rounded-2xl border border-purple-100 backdrop-blur-sm">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-sm text-gray-500 font-medium"> {{ $userLevel}} </span>
                </div>
            </div>
        ...
        @if ($saveSuccess)
            <div class="fixed top-6 right-6 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-8 py-4 rounded-2xl shadow-2xl flex items-center border border-green-400"
    ...
    <div x-show="modalOpen"
         ...
         style="z-index: 99999 !important; position: fixed !important; top: 0 !important; left: 0 !important; width: 100vw !important; height: 100vh !important; margin: 0 !important;"
        ...
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md mx-auto transform transition-all duration-300"
            ...
            <div class="p-8">
                <div class="text-center">
                    ...
                    <p class="text-gray-600 text-lg leading-relaxed">Are you sure you want to end your session? You'll need to sign in again to access your account.</p>
                </div>
    ...
    <div x-show="editModalOpen"
         x-cloak
         @keydown.escape.window="$wire.set('showModalEdit', false)"
         class="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center p-4"
         style="z-index: 99999 !important; position: fixed !important; top: 0 !important; left: 0 !important; width: 100vw !important; height: 100vh !important; margin: 0 !important;"
         x-transition:enter="transition ease-out duration-300"
         x-transition:enter-start="opacity-0" 
         ...
         x-transition:leave-start="opacity-100"
         x-transition:leave-end="opacity-0"
         @click.self="$wire.set('showModalEdit', false)">
        
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-lg mx-auto transform transition-all duration-300 max-h-[95vh] overflow-y-auto"
            style="position: relative; z-index: 99999 !important;"
            x-transition:enter="transition ease-out duration-300 transform"
            x-transition:enter-start="opacity-0 scale-95 translate-y-4"
            x-transition:enter-end="opacity-100 scale-100 translate-y-0"
            ...
            <div class="p-8">
                <div class="text-center mb-8">
                    <div class="w-20 h-20 bg-gradient-to-br from-purple-400 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                ...
                <form wire:submit.prevent="updateProfile" class="space-y-6">
                    <!-- Username Field -->
                    <div class="space-y-2">
                        <label class="block text-left text-gray-700 font-bold text-sm uppercase tracking-wide">Username</label>
                        <div class="relative">
                    ...
                    <div x-data="{ showPassword: false }" class="space-y-2">
                        <label class="block text-left text-gray-700 font-bold text-sm uppercase tracking-wide">New Password</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    ...
                    <div x-data="{ showConfirmPassword: false }" class="space-y-2">
                        <label class="block text-left text-gray-700 font-bold text-sm uppercase tracking-wide">Confirm Password</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <i class="fa-solid fa-lock text-gray-400"></i>
                            </div>
                            <input :type="showConfirmPassword ? 'text' : 'password'" wire:model.defer="password_confirm"
                                class="w-full pl-12 pr-12 py-4 border-2 border-gray-200 rounded-2xl shadow-sm focus:ring-2 focus:ring-purple-300 focus:border-purple-400 focus:outline-none text-gray-900 font-medium transition-all duration-200"
    ...
    <style>
        ...
        /* Ensure modal overlays are on top */
        .navbar-component > div:last-child,
        .navbar-component > div:nth-last-child(2) {
        ...
        .navbar-component [style*="z-index: 99999"] {
